...
export class CurrencyApiService {
  ...
  select(): Observable<Currency[]>{
    return this.http.get<Currency[]>(server() + '/api/Currencies');
  }
  get(id:any) : Observable<Currency>{
    return this.http.get<Currency>(server() + '/api/Currencies/'+id);
  }
  add(data : any){
    const model : any = this.mapper(data);
    this.http.post<any>(server() + '/api/Currencies/', model).subscribe(
  ...
  edit(data : any){
    const model : any = this.mapper(data);
    this.http.put<any>(server() + '/api/Currencies/' + data.currencyCode, model).subscribe(
  ...
  delete(data : any){
    return this.http.delete<any>(server() + '/api/Currencies/' + data.currencyCode);
  }
  mapper(data:any) : any{
