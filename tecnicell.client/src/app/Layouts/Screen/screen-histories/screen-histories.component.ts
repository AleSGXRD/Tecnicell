...
@Component({
  ...
  templateUrl: './screen-histories.component.html',
  styleUrl: './screen-histories.component.css'
})
export class ScreenHistoriesComponent {


  load : boolean = false;

  //Direction Page
  direction : string[]=['Main', "Pantallas", "Historial"];
