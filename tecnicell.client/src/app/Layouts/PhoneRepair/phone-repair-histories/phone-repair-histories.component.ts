...
@Component({
  ...
  templateUrl: './phone-repair-histories.component.html',
  styleUrl: './phone-repair-histories.component.css'
})
export class PhoneRepairHistoriesComponent {


  load : boolean = false;

  //Direction Page
  direction : string[]=['Main', "Teléfonos Reparar", "Historial"];
