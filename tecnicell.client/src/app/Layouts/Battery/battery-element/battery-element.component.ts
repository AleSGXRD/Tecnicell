...
import { BatteryResponse } from '../../../Interfaces/business/ApiResponses/BatteryResponse';
...
@Component({
  ...
  styleUrl: './battery-element.component.css'
})
export class BatteryElementComponent {
  id : any;
  loaded : boolean[] = [false,false,false,false];

  direction : string[] = ["Main", "Batería"];
  value!: BatteryResponse;
  ...
  constructor(private route:ActivatedRoute,
    ...
    public historyService : BatteryHistoryApiService,
        ...
        this.apiService.get(this.id).subscribe(
          res => {
            ...
            this.formHistories = this.formBuilder.nonNullable.group({
              batteryCode: [this.value.view.code,[]],
              salePrice: [this.value.view.salePrice,[]],
              warrantyBattery : [this.value.view.warranty, []],
              userCode:[undefined, []],
              date:[new Date(),[]],
  ...
  editData(){
    const form  = this.formBuilder.group({
      batteryCode: [this.value.view.code,[Validators.required]],
